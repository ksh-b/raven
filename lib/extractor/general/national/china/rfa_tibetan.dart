...
class RfaTibetan extends Publisher {
  @override
  String get name => "ཨེ་ཤེ་ཡ་རང་དབང་རླུང་འཕྲིན་ཁང་";

  @override
  String get homePage => "https://www.rfa.org/tibetan";

  @override
  Future<Map<String, String>> get categories async {
    Map<String, String> map = {"Tibetan": "tibetan"};
    ...
    return map..removeWhere((key, value) => value=="video",);
  }
