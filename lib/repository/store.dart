...
class Store {
  ...
  static List<UserSubscription> get customSubscriptions {
    return List<UserSubscription>.from(
        subscriptions.get("custom", defaultValue: []));
  }
  ...
  static void saveOfflineArticles(List<Article> articles) {
  ...
  static List<Article> getOfflineArticles() {
    return List<Article>.from(offlineArticles.get("list", defaultValue: []));
  }
}
